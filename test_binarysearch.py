            ...
            for a in isl_gif:
                for i in range(10000):
                        ...
                        try:
                                ...
                                print(" ")
                        plt.close()
            print("Search time:", search_time/10000*len(isl_gif), "seconds")
